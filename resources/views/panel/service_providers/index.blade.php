                     ...
                     <div class="card">
                         <div class="card-header">
                            Proveedores de servicio
                             ...
                             @endif --}}
                             <a class="pull-right" href="{!! route('service-providers.create') !!}" title="Agregar proveedor de servicio"><i class="fa fa-plus-square fa-lg"></i></a>
                         </div>
                         <div class="card-body">
                             @include('panel.service_providers.table')
