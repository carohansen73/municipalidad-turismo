...
<div class="row">
    ...
    <div class="form-group col-sm-12">
        {!! Field::text('name', null, ['label' => 'Nombre *', 'autofocus', 'data-validation' => 'required length', 'data-validation-length' => '1-30']) !!}
    </div>
</div>
...
<div class="row">
    ...
    <div class="form-group col-sm-12">
        ...
        <a href="{!! route('posts.categorias.index') !!}" class="btn btn-secondary">Cancelar</a>
    </div>
</div>
