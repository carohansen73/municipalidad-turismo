<div class="row">
    <div class="col-md-4">
        ...
        <img src="{!! url('imagenes/medium/'. $post->important_image) !!}" alt="{!! $post->title !!}" class="img-thumbnail">
    </div>
                    ...
                    @foreach( $post->galeryImages as $galeryImage )
                        <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                            ...
                            <div class="carousel-caption d-none d-md-block">
                                <h3></h3>
                                <p>
                                    {{-- <a href="{!! route('galeria.imagen.destroy', $galeryImage->id) !!}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Borrar</a> --}}
                                    {!! Form::open(['route' => ['galeria.imagen.destroy', $galeryImage->id], 'method' => 'delete']) !!}
